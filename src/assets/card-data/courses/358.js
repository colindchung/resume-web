const data = {
    ...
    topics: "The course covered the history, protocols and design principles of each layer of the Internet (Link, Network, Transport). The Labs were centered around simulating and comparing the performance of different network configurations, collision detection/avoidance mechanisms and scheduling algorithms.",
    stack: [
        {
            tooltip: "C++",
            img: "cpp"
