const data = {
    ...
    bullets: [
        ...
        "Finding a secure host to serve both the frontend and backend was difficult. Keeping cost in mind, I decided to host the frontend in Netlify and the backend using an Elastic Beanstalk environment in Amazon Web Services. The backend uses ACM for certificate management and RDS for the database.",
